...
setTimeout(function () {
    ...
    (function () {
      ...
      XRManager.prototype.onRequestVRSession = function () {
        ...
        window.requestAnimationFrame( tempRender );
        navigator.xr.requestSession('immersive-vr', { //request Session might be how this works
...
var ASM_CONSTS = {
  3718340: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3718395: function($0) {performance.now = function() { return $0; };},  
 3718443: function($0) {performance.now = function() { return $0; };},  
 3718491: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3718546: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3718607: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3718671: function() {return Module.webglContextAttributes.powerPreference;}
};
